...
import bio2 from "../static/img/chuck_approves.jpg";
    ...
    return (
        <section className="section-stories">
            ...
            <div className="row">
                <div className="story">
                    <figure className="story__shape">
                        <img src={bio2} alt="person loving life" className="story__img story__img-2" />
                        <figcaption className="story__caption">Chuck Norris</figcaption>
                    </figure>
                    <div className="story__text">
                        <h3 className="heading-tertiary u-margin-bottom-small">I approve of Powder</h3>
                        <p>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure, quasi porro ullam illum dolores voluptates deserunt autem eligendi natus alias officia, ipsam, atque consectetur incidunt? Explicabo dolorem optio iste assumenda?
                        </p>
                    </div>
